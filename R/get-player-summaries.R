...
#'
#' Get basic profile information for a list of Steam ID's.
#'
#' @export
#' @param steam_key a Steam Web API Key. 
#'   Get a key at \url{http://steamcommunity.com/dev/apikey}
#' @param steam_ids a vector of Steam ID's. 
...
get_player_summaries <- function(steam_key, steam_ids = c()) {
  ids = paste(steam_ids, sep = ",")
